...
and any recommendation. (Exempt from a computable structure on purpose: this is frozen
history, written once and never read for current state — so, unlike a living-truth doc,
its internal shape isn't load-bearing.)
